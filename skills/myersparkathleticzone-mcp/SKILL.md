...
- **Past seasons work**, though the school lists fewer teams for them; `mpaz_list_teams` finds those ids via the sport pages when the all-school schedule is empty.
